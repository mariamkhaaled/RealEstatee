...
const AdminDashboard: React.FC = () => {
  ...
  // 🔐 حماية إضافية داخل الصفحة نفسها (Defense in depth)
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          System statistics and approval queue.
        </p>

        {/* 👇 التعديل الجديد (عرض role فقط كمعلومة) */}
        <div className="mt-2 text-sm text-muted-foreground">
          Logged in as: <span className="font-semibold text-foreground">Admin</span>
        </div>
      </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded bg-secondary overflow-hidden flex-shrink-0">
                        <img
                          src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=100&q=80"
