...
const PropertyDetails: React.FC = () => {
  ...
  if (loading) {
    return <div className="max-w-7xl mx-auto px-4 py-8">Loading property...</div>;
  }

  if (!listing) {
    return <div className="max-w-7xl mx-auto px-4 py-8">Property not found.</div>;
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10 h-[500px] rounded-2xl overflow-hidden">
        <div className="md:col-span-3 h-full">
          <img src={safeImages[0]} alt="Main" className="w-full h-full object-cover" />
        </div>

        <div className="hidden md:flex flex-col gap-4 h-full">
          <img src={safeImages[1] || safeImages[0]} alt="Sub 1" className="w-full h-1/2 object-cover" />
          <div className="relative w-full h-1/2">
            <img src={safeImages[2] || safeImages[0]} alt="Sub 2" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
          ...
          <Card className="shadow-custom border-border">
            <CardContent className="p-6">
              ...
              <form className="space-y-4" onSubmit={handleRequestSubmit}>
                ...
                <Button className="w-full" disabled={isListingClosed || isSubmitting}>
